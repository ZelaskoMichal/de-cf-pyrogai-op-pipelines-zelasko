"""Unit tests for template_pipelines/steps/iris_3_fix_data.py."""

from unittest.mock import MagicMock, patch

import pytest

from template_pipelines.steps.ml_iris.iris_3_fix_data import FixDataStep
...
@patch("template_pipelines.steps.ml_iris.iris_3_fix_data.pd")
