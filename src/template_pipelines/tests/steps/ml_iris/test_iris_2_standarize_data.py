"""Unit tests for template_pipelines/steps/iris_2_standarize_data.py."""

from unittest.mock import MagicMock, patch

import pytest

from template_pipelines.steps.ml_iris.iris_2_standarize_data import StandardizeDataStep
...
@patch("template_pipelines.steps.ml_iris.iris_2_standarize_data.pd")
